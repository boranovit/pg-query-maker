...
function setAll(obj, config){
    return {
        ...
        groupBy:        setClause("GROUP BY", obj.groupBy),
        having:         setClause("HAVING", obj.having),
        schemaOrderBy:  setClause("ORDER BY", obj.schemaOrderBy),
        orderBy:        setClause("ORDER BY", obj.orderBy),
        schemaLimit:    setClause("LIMIT", obj.schemaLimit),
